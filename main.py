...
def get_mp3(text: str, voice: str, api_key: str = None) -> bytes:
    ...
    try:
        ...
        response = client.audio.speech.create(
            ...
            voice=voice,
            input=text,
            instructions="""Voice Affect: A cheerful podcast host.\n\nTone: A warm, inviting, clear, and confident tone that mimics natural speech without sounding overly formal or scripted.\n\nPacing: A moderate pace that allows listeners to absorb information comfortably without feeling rushed or bored, adjusting pacing to highlight key points—slowing down for important information or speeding up slightly during exciting moments to build energy.\n\nEmotion: Genuine, authentic, and engaging, matching emotion to the subject matter—enthusiastic for exciting news, empathetic for sensitive topics, humorous when lighthearted, etc.\n\nPronunciation: Clear, precise, and steady, ensuring the information conveyed is easily understood while maintaining a natural, conversational flow.""",
            response_format="mp3"
        )
