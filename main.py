...
def generate_audio(files, language="English", openai_api_key: str = None, openai_base_url: str = None) -> bytes:
    ...
    def generate_dialogue(text: str, language: str) -> Dialogue:
        ...
        Important: The ENTIRE podcast dialogue (including brainstorming, scratchpad, and actual dialogue) should be written in {language}. If 'Chinese', use correct idiomatic Traditional Chinese (繁體中文) suitable for a Hong Kong audience.
